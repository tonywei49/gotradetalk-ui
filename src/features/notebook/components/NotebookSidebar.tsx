                    ...
                    <>
                        <div className="mb-3 flex items-center gap-2 text-sm">
                            <button
                                ...
                                className={`rounded-full px-3 py-1.5 ${quickFilter === "allSources" ? "bg-slate-800 text-white dark:bg-slate-100 dark:text-slate-900" : "bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-300"}`}
                            >
                            ...
                            <button
                                ...
                                className={`rounded-full px-3 py-1.5 ${quickFilter === "knowledge" ? "bg-emerald-600 text-white" : "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300"}`}
                            >
                            ...
                            <button
                                ...
                                className={`rounded-full px-3 py-1.5 ${quickFilter === "note" ? "bg-slate-700 text-white" : "bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-300"}`}
                            >
                            ...
                            {showCompanyFilter && (
                                <button
                                    ...
                                    className={`rounded-full px-3 py-1.5 ${quickFilter === "company" ? "bg-indigo-600 text-white" : "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300"}`}
                                >
                        ...
                        <div className="flex items-center gap-2">
                            <input
                                ...
                                className="min-w-0 flex-1 rounded-xl border border-gray-200 bg-white px-4 py-3 text-[15px] text-slate-700 outline-none focus:border-emerald-400 focus:ring-1 focus:ring-emerald-400 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100"
                            />
                            <button
                                type="button"
            ...
            <div className="flex-1 min-h-0 overflow-y-scroll gt-visible-scrollbar p-3 space-y-2">
                ...
                {mode === "notebook" && listState === "ready" && hasMore && (
                    <button
                        ...
                        className="w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-base font-semibold text-slate-700 disabled:cursor-not-allowed disabled:opacity-60 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200"
                    >
                        {loadingMore
