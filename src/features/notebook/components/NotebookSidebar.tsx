...
export function NotebookSidebar({
    ...
    const [mode, setMode] = useState<NotebookSidebarMode>("notebook");
    ...
    return (
        <>
            ...
            <div className="p-3 border-b border-gray-100 dark:border-slate-800">
                ...
                <div className="flex items-center gap-2">
                    <input
                        ...
                        placeholder={
                            mode === "notebook"
                                ? t("layout.notebook.searchNotebookPlaceholder", "Search notebook")
                                : t("layout.notebook.searchSummaryPlaceholder", "Search AI chat summary")
                        }
                    ...
                    <button
                        type="button"
                        disabled={mode !== "notebook" || busy || sourceScope === "company"}
                        onClick={onCreate}
            ...
            <div className="flex-1 min-h-0 overflow-y-scroll gt-visible-scrollbar p-3 space-y-2">
                {mode === "chatSummary" && (
                    <div className="rounded-xl border border-dashed border-gray-300 bg-gray-50 p-4 text-sm text-slate-500 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-400">
                        {t("layout.notebook.summaryEmpty", "AI chat summary is coming soon.")}
                    </div>
                )}
